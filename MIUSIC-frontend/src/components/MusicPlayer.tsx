...
const MusicPlayer: React.FC = () => {
  ...
  const { currentSong, playNextSong, playPreviousSong, isPlaying, togglePlayPause } = usePlayer();
    ...
    <div className="music-player">
      <div className="music-player-content">
        ...
        <div className="player-controls">
          ...
          <IonButton fill="clear" onClick={handleTogglePlayPause} className="play-pause-button">
